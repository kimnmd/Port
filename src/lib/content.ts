...
export const caseStudies: CaseStudy[] = [
  {
    ...
    report: [
      ...
      },
      {
        ...
        paragraphs: [
          "Turnover started dropping in the first year. I'll add the same caveat we gave leadership back then: we never fully controlled turnover and knew we wouldn't, because the roots ran too deep for one round of changes to reach. The better evidence showed up slowly. When we lined up five years of data, the line didn't dip and bounce back the way a short-lived boost would. It just kept dropping, from 32% down to about 17% by year five. Structure sticks; campaigns fade.",
